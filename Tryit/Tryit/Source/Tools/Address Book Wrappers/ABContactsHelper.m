...
+ (NSArray *) contactsWithOrder
{
    ABAddressBookRef addressBook = [ABStandin addressBook];
    ABRecordRef source = ABAddressBookCopyDefaultSource(addressBook);
    NSArray *thePeople = (__bridge_transfer NSArray *)ABAddressBookCopyArrayOfAllPeopleInSourceWithSortOrdering(addressBook, source, kABPersonSortByLastName);
