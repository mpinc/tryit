...
- (NSArray *) arrayForProperty: (ABPropertyID) anID
{
    ...
    if (anID == kABPersonPhoneProperty) {
        NSMutableArray *returnArray = [[NSMutableArray alloc] initWithCapacity:[items count]];
        for (NSString *phoneNumber in items) {
            NSString *mobileNumber = [NSString stringWithString:phoneNumber];
            mobileNumber = [mobileNumber stringByReplacingOccurrencesOfString:@"(" withString:@""];
            mobileNumber = [mobileNumber stringByReplacingOccurrencesOfString:@")" withString:@""];
            mobileNumber = [mobileNumber stringByReplacingOccurrencesOfString:@" " withString:@""];
            mobileNumber = [mobileNumber stringByReplacingOccurrencesOfString:@"-" withString:@""];
            mobileNumber = [mobileNumber stringByReplacingOccurrencesOfString:@"+" withString:@""];
            [returnArray addObject:mobileNumber];
        }
